...
This is required for [[https://github.com/casperlabs/ceps/pull/1234][casperlabs/ceps#1234]] and [[https://github.com/casperlabs/ceps/pull/9999][casperlabs/ceps#9999]].
...
[[https://github.com/xcthulhu/casper-node/blob/0a7f9e5fd7608e2f6574c1e213bd9f5e35880af5/node/src/components/linear_chain_sync.rs#L85-L93][=linear_chain_sync::State::SyncingDescendents]]=.

We could add a field =validators= to this with type
[[https://github.com/xcthulhu/casper-node/blob/0a7f9e5fd7608e2f6574c1e213bd9f5e35880af5/types/src/auction/types.rs#L15][=types::ValidatorWeights=]] (i.e. =BTreeMap<PublicKey, U512>=). This would
be updated as switch blocks are processed.
...
- What changes need to be made to transitioning from the
  =SyncingDescendents= state to ordinary validation?  This is addressed
